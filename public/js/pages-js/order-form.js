...
function checkFileValidation() {
    var e = $(this).closest("form").attr("id"),
        i = this.files;
    return checkFileSize(i) ? checkFileExtenstion(i) ? ($("#" + e + " #form-response").removeClass("notification-field-error notification-field-success").hide(), $("#" + e + " #form-response").find(".notification-message").text(""), !0) : ($("#" + e + " #form-response").addClass("notification-field-error").show(), $("#" + e + " #form-response").find(".notification-message").text("Tip fajla mora biti jedan od sledećih: PDF, DOC ili DOCX."), !1) : ($("#" + e + " #form-response").addClass("notification-field-error").show(), $("#" + e + " #form-response").find(".notification-message").text("Veličina fajla mora biti manja od 5MB."), !1)
}
